...
export default function ReportsView() {
  const { visibleDocuments: documents, auditLogs, showToast } = useApp();
  ...
  const handleExportPDF = () => {
    ...
    downloadReportPDF(filteredDocuments, startDate, endDate, categoryFilter);
    showToast(`Reporte PDF oficial descargado (${filteredDocuments.length} expedientes)`, 'success');
  };
