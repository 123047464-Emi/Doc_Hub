...
// Shared Unified User Profiles (Web ↔ Mobile Sync)
let sharedProfiles = [
  { id: 'u1', username: 'juez1', password: '1234', role: 'Administrador', name: 'Lic. Fernando Reyes', email: 'fernando.reyes@poderjudicial.gob.mx', cargo: 'Juez 3° Familiar / Titular del Juzgado', status: 'Activo', cedula: 'CED-8842109', appMobileConnected: true },
  { id: 'u2', username: 'notario1', password: '1234', role: 'Supervisor', name: 'Not. Karla Sánchez', email: 'karla.sanchez@notaria24.com.mx', cargo: 'Notaria Pública 24 / Fe Pública', status: 'Activo', cedula: 'CED-9940182', appMobileConnected: true },
  { id: 'u3', username: 'abogado1', password: '1234', role: 'Revisor', name: 'Lic. Mario Torres', email: 'mario.torres@bufetejuridico.com', cargo: 'Abogado Litigante / Consultor Legal', status: 'Activo', cedula: 'CED-7731920', appMobileConnected: true },
  { id: 'u4', username: 'parte1', password: '1234', role: 'Firmante', name: 'Dra. Ana Gómez', email: 'ana.gomez@corporativo.com', cargo: 'Representante Legal Corporativa', status: 'Activo', cedula: 'CED-5510294', appMobileConnected: true },
  { id: 'u5', username: 'testigo1', password: '1234', role: 'Usuario', name: 'Ing. Carlos Ruiz', email: 'carlos.ruiz@peritaje.com', cargo: 'Perito Valuador Judicial', status: 'Activo', cedula: 'CED-3310492', appMobileConnected: true }
];
