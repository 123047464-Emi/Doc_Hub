    ...
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div>
        ...
        <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>
          Firma electrónica avanzada encriptada en cumplimiento con normativas de seguridad universitarias.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '24px' }}>
        ...
        <div className="card-glass" style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--success)', fontSize: '0.8rem', fontWeight: 700 }}>
              <Lock size={15} /> Conexión Segura SSL/TLS
            </div>
          </div>
