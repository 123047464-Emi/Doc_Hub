...
function MainContent() {
  ...
  const renderView = () => {
    switch (activeTab) {
      case 'dashboard':
        return isAdmin ? <DashboardView /> : <AccessRestrictedBanner tabName="Dashboard Legal" />;
      ...
      case 'usuarios':
        return isAdmin ? <UsersView /> : <AccessRestrictedBanner tabName="Usuarios y Abogados" />;
      case 'roles':
      ...
      default:
        return isAdmin ? <DashboardView /> : <DocumentosView />;
    }
  };
