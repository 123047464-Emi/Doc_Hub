...
export default function Sidebar() {
  ...
  const navItems = [
    { id: 'dashboard', label: 'Dashboard Legal', icon: LayoutDashboard, adminOnly: true },
    { id: 'documentos', label: 'Documentos', icon: FileText, badge: '5' },
    { id: 'version_control', label: 'Control de versiones', icon: History },
    { id: 'flujo_aprobacion', label: 'Flujo de aprobación', icon: GitFork },
    { id: 'firmas', label: 'Firmas digitales (FIEL)', icon: PenTool, badge: '2', badgeColor: 'purple' },
    { id: 'usuarios', label: 'Usuarios y Abogados', icon: Users, adminOnly: true },
